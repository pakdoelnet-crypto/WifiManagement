    ...
    <AuthenticatedLayout>
        ...
        <div class="py-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-6 text-slate-100">
            ...
            <div class="grid grid-cols-1 min-[450px]:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4 sm:gap-5">
                ...
                <div class="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg flex flex-col justify-between h-[125px] transition duration-300 hover:border-emerald-500/30">
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Hotspot Aktif</span>
                        <div class="text-emerald-500 rounded-lg">
                    ...
                    <div class="mt-2 min-w-0">
                        ...
                        <span class="text-[10px] text-slate-500 block truncate mt-1">Sesi aktif hotspot</span>
                    </div>
                </div>

                <!-- Card 2: PPP Aktif -->
                <div class="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg flex flex-col justify-between h-[125px] transition duration-300 hover:border-orange-500/30">
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-slate-400 uppercase tracking-wider flex items-center gap-1.5">
                            PPP Aktif
                            <span class="h-1.5 w-1.5 rounded-full bg-orange-500 animate-ping" v-if="liveOnlineCount > 0"></span>
                        </span>
                        <div class="text-orange-500 rounded-lg">
                    ...
                    <div class="mt-2 min-w-0">
                        ...
                        <span class="text-[10px] text-slate-500 block truncate mt-1">Sesi PPPoE aktif</span>
                    </div>
                </div>

                <!-- Card 3: Hari Ini -->
                <div class="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg flex flex-col justify-between h-[125px] transition duration-300 hover:border-cyan-500/30">
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Hari Ini</span>
                        <div class="text-cyan-500 rounded-lg">
                            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="mt-2 min-w-0">
                        <div class="text-2xl sm:text-3xl font-black text-cyan-500 leading-none truncate">{{ stats.paidInvoicesToday ? formatRupiah(stats.paidInvoicesToday) : 'Rp 0' }}</div>
                        <span class="text-[10px] text-slate-500 block truncate mt-1">Pendapatan hari ini</span>
                    </div>
                </div>

                <!-- Card 4: Bulan Ini -->
                <div class="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg flex flex-col justify-between h-[125px] transition duration-300 hover:border-yellow-500/30">
                    <div class="flex justify-between items-start">
                    ...
                    <div class="mt-2 min-w-0">
                        <div class="text-2xl sm:text-3xl font-black text-yellow-500 leading-none truncate">{{ formatRupiah(stats.paidInvoicesThisMonth) }}</div>
                        <span class="text-[10px] text-slate-500 block truncate mt-1">Pendapatan bulan ini</span>
                    </div>
                </div>

                <!-- Card 5: Model Perangkat -->
                <div class="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg flex flex-col justify-between h-[125px] transition duration-300 hover:border-indigo-500/30">
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Model Perangkat</span>
                        <div class="text-indigo-400 rounded-lg">
                            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="mt-2 min-w-0">
                        <div class="text-lg sm:text-xl font-black text-white leading-none truncate">{{ primaryRouter.board_name || 'RB450Gx4 (Demo)' }}</div>
                        <span class="text-[10px] text-slate-500 block truncate mt-1 uppercase font-bold" :class="primaryRouter.status === 'online' ? 'text-emerald-400' : 'text-rose-400'">
                ...
                <!-- Card 6: Uptime -->
                <div class="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg flex flex-col justify-between h-[125px] transition duration-300 hover:border-purple-500/30">
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Uptime</span>
                        <div class="text-purple-400 rounded-lg">
                            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="mt-2 min-w-0">
                        <div class="text-base sm:text-lg font-black text-white leading-none truncate">{{ primaryRouter.uptime || '-' }}</div>
                        <span class="text-[10px] text-slate-500 block truncate mt-1">Waktu aktif router</span>
                    </div>
                </div>
